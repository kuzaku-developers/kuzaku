...
class supportserver(commands.Cog):
    ...
    async def on_member_join(self, member: disnake.Member):
        if member.guild.id == 761991504793174117:
            Role = disnake.utils.get(member.guild.roles, id=868788263035498507)
            ...
            await card.setAvatarBackground(
                "https://images.unsplash.com/photo-1600758208050-a22f17dc5bb9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
            )
            ...
            await ch.send(file=disnake.File(fp=file, filename="welcome.png"))
